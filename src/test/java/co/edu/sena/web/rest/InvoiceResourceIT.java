...
class InvoiceResourceIT {
    ...
    private static final Integer DEFAULT_QUANTITY_FOR_SERVICES = 1;
    private static final Integer UPDATED_QUANTITY_FOR_SERVICES = 2;
    ...
    private static final Double DEFAULT_TOTAL_IVA = 1D;
    private static final Double UPDATED_TOTAL_IVA = 2D;
    ...
    public static Invoice createEntity(EntityManager em) {
        Invoice invoice = new Invoice()
            ...
            .quantityForServices(DEFAULT_QUANTITY_FOR_SERVICES)
    ...
    public static Invoice createUpdatedEntity(EntityManager em) {
        Invoice invoice = new Invoice()
            ...
            .quantityForServices(UPDATED_QUANTITY_FOR_SERVICES)
    ...
    void createInvoice() throws Exception {
        ...
        assertThat(testInvoice.getDataInit()).isEqualTo(DEFAULT_DATA_INIT);
        ...
        assertThat(testInvoice.getQuantityForServices()).isEqualTo(DEFAULT_QUANTITY_FOR_SERVICES);
        ...
        assertThat(testInvoice.getTotalIva()).isEqualTo(DEFAULT_TOTAL_IVA);
    ...
    @Test
    @Transactional
    void checkQuantityForServicesIsRequired() throws Exception {
        int databaseSizeBeforeTest = invoiceRepository.findAll().size();
        // set the field null
        invoice.setQuantityForServices(null);
    ...
    void getAllInvoices() throws Exception {
        ...
        restInvoiceMockMvc
            ...
            .andExpect(jsonPath("$.[*].quantityForServices").value(hasItem(DEFAULT_QUANTITY_FOR_SERVICES)))
            ...
            .andExpect(jsonPath("$.[*].totalIva").value(hasItem(DEFAULT_TOTAL_IVA.doubleValue())))
    ...
    void getInvoice() throws Exception {
        ...
        restInvoiceMockMvc
            ...
            .andExpect(jsonPath("$.quantityForServices").value(DEFAULT_QUANTITY_FOR_SERVICES))
            ...
            .andExpect(jsonPath("$.totalIva").value(DEFAULT_TOTAL_IVA.doubleValue()))
    ...
    void putNewInvoice() throws Exception {
        ...
        Invoice testInvoice = invoiceList.get(invoiceList.size() - 1);
        assertThat(testInvoice.getDataInit()).isEqualTo(UPDATED_DATA_INIT);
        ...
        assertThat(testInvoice.getQuantityForServices()).isEqualTo(UPDATED_QUANTITY_FOR_SERVICES);
        ...
        assertThat(testInvoice.getTotalIva()).isEqualTo(UPDATED_TOTAL_IVA);
